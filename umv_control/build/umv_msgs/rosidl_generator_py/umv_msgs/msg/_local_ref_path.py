...
class LocalRefPath(metaclass=Metaclass_LocalRefPath):
    ...
    def __init__(self, **kwargs):
        ...
        self.ego_yaw = kwargs.get('ego_yaw', float())
        self.brake_flag = kwargs.get('brake_flag', int())
    ...
    def __eq__(self, other):
        ...
        if self.ego_y != other.ego_y:
            return False
        if self.ego_yaw != other.ego_yaw:
            return False
        if self.brake_flag != other.brake_flag:
            return False
        return True
    ...
    def ego_x(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'ego_x' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._ego_x = value
    ...
    def ego_y(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'ego_y' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._ego_y = value

    @builtins.property
    def ego_yaw(self):
        """Message field 'ego_yaw'."""
        return self._ego_yaw

    @ego_yaw.setter
    def ego_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'ego_yaw' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'ego_yaw' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._ego_yaw = value

    @builtins.property
    def brake_flag(self):
        """Message field 'brake_flag'."""
        return self._brake_flag

    @brake_flag.setter
    def brake_flag(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'brake_flag' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'brake_flag' field must be an integer in [-2147483648, 2147483647]"
        self._brake_flag = value
