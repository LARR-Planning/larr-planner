...
class Init_LocalRefPath_brake_flag
{
public:
  explicit Init_LocalRefPath_brake_flag(::umv_msgs::msg::LocalRefPath & msg)
  : msg_(msg)
  {}
  ::umv_msgs::msg::LocalRefPath brake_flag(::umv_msgs::msg::LocalRefPath::_brake_flag_type arg)
  {
    msg_.brake_flag = std::move(arg);
...
class Init_LocalRefPath_ego_yaw
{
public:
  explicit Init_LocalRefPath_ego_yaw(::umv_msgs::msg::LocalRefPath & msg)
  : msg_(msg)
  {}
  Init_LocalRefPath_brake_flag ego_yaw(::umv_msgs::msg::LocalRefPath::_ego_yaw_type arg)
  {
    msg_.ego_yaw = std::move(arg);
    return Init_LocalRefPath_brake_flag(msg_);
  }
...
class Init_LocalRefPath_ego_y
{
public:
  explicit Init_LocalRefPath_ego_y(::umv_msgs::msg::LocalRefPath & msg)
  : msg_(msg)
  {}
  Init_LocalRefPath_ego_yaw ego_y(::umv_msgs::msg::LocalRefPath::_ego_y_type arg)
  {
    msg_.ego_y = std::move(arg);
    return Init_LocalRefPath_ego_yaw(msg_);
  }
...
class Init_LocalRefPath_ego_x
{
public:
  explicit Init_LocalRefPath_ego_x(::umv_msgs::msg::LocalRefPath & msg)
  : msg_(msg)
  {}
  Init_LocalRefPath_ego_y ego_x(::umv_msgs::msg::LocalRefPath::_ego_x_type arg)
  {
    msg_.ego_x = std::move(arg);
    return Init_LocalRefPath_ego_y(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_LocalRefPath_ego_x ego_s(::umv_msgs::msg::LocalRefPath::_ego_s_type arg)
  {
    msg_.ego_s = std::move(arg);
    return Init_LocalRefPath_ego_x(msg_);
  }
