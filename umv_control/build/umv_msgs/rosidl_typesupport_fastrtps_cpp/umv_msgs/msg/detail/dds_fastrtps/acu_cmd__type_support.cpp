...
#include "umv_msgs/msg/detail/acu_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = umv_msgs::msg::AcuCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const umv_msgs::msg::AcuCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<umv_msgs::msg::AcuCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AcuCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const umv_msgs::msg::AcuCmd *>(
...
static size_t _AcuCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AcuCmd(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AcuCmd__callbacks = {
  "umv_msgs::msg",
  "AcuCmd",
...
static rosidl_message_type_support_t _AcuCmd__handle = {
...
{
  return &umv_msgs::msg::typesupport_fastrtps_cpp::_AcuCmd__handle;
}
