...
static const _GlobalPath_type_support_symbol_names_t _GlobalPath_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, umv_msgs, msg, GlobalPath)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, umv_msgs, msg, GlobalPath)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, umv_msgs, msg, GlobalPath)() {
  return &::umv_msgs::msg::rosidl_typesupport_c::GlobalPath_message_type_support_handle;
}
