...
static rosidl_typesupport_introspection_c__MessageMember umv_msgs__msg__LocalRefPath__rosidl_typesupport_introspection_c__LocalRefPath_message_member_array[12] = {
  {
    "header",  // name
